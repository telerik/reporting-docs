...
1. Locate the leaf static group that represents the header or footer you want to modify. Static groups appear with a distinct icon and gray text.
	...
	![Telerik Reporting Standalone Report Designer Group Explorer in Extended Mode with a table selected to show group hierarchy](images/extended-mode-group-explorer-table.png)

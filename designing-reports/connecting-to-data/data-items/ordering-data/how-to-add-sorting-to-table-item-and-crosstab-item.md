...
1. In the [Visual Studio Report Designer](slug:telerikreporting/designing-reports/report-designer-tools/desktop-designers/visual-studio-report-designer/overview).
...
1. Open the [Group Explorer tool](slug:telerikreporting/designing-reports/report-designer-tools/desktop-designers/tools/group-explorer).
1. In the [Visual Studio Report Designer](slug:telerikreporting/designing-reports/report-designer-tools/desktop-designers/visual-studio-report-designer/overview), select the Table/Crosstab. This makes the selected item active in the [Group Explorer tool](slug:telerikreporting/designing-reports/report-designer-tools/desktop-designers/tools/group-explorer).

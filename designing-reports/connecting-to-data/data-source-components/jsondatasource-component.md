...
> The JSON data source relies on and reuses some of the Web Service data source functionalities. To preview JSON data source reports in your application it is required to reference the **Telerik.Reporting.WebServiceDataSource** DLL or the corresponding NuGet package in the application.

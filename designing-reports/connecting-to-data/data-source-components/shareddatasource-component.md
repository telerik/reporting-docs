...
The [SharedDataSource component](/api/Telerik.Reporting.SharedDataSource) enables report designers to easily create and reuse a data source component across multiple reports.
...
|Path|Represent the relative(to the report definition) path to the `.sdsx` file. [Report expressions](slug:telerikreporting/designing-reports/connecting-to-data/expressions/overview) are supported.|

...
description: "Find out what the built-in Date and Time Functions are in Telerik Reporting and how to use them in expressions in reports."
...
tags: date, time, functions, expressions, report
published: True
position: 4
...
Use these functions to calculate date and time values. Their default format is determined by your local computer's locale settings. To change the format, you can use the [report format builder](slug:telerikreporting/designing-reports/report-designer-tools/desktop-designers/tools/format-builder-dialog) in the Report Designer of your choice.

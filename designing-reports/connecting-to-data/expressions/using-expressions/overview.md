...
Design your reports so that [conditional formatting applies different styles](slug:telerikreporting/designing-reports/connecting-to-data/expressions/using-expressions/conditional-formatting) based on the data in the report. This is possible when you use an expression instead of a static value for the style properties of a report item.
...
You can use an expression to combine values from multiple columns and use the result as [a parameter value or label](slug:telerikreporting/designing-reports/connecting-to-data/expressions/using-expressions/grouping,-filtering-and-sorting).

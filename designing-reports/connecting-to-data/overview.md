...
For more details see topics in the [data item configuration documentation](slug:telerikreporting/designing-reports/connecting-to-data/data-items/overview) section.
...
For more details see topics in the [report expressions documentation](slug:telerikreporting/designing-reports/connecting-to-data/expressions/overview) section.
...
For more details see topics in the [report parameter documentation](slug:telerikreporting/designing-reports/connecting-to-data/report-parameters/overview) section.

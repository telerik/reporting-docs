...
>important You need to reference a __PFX__ file. The reason is that a password related to the certificate file is required and it can be embedded in a 'pfx' but not in a 'cer' file.

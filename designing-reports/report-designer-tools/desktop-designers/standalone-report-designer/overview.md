...
* __View Mode Buttons:__ Use these buttons to switch between the `Design`, `Preview` view.
...
* __ToolStrip__ : This is a UI element that includes various buttons that are designed to ease you while you design reports. The `ToolStrip`, which is shown on the image below, is placed in the lower-left corner of the design surface.

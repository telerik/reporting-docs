...
- The **Configure Data Source Command** step will display next.
  ...
  - Click the **Query Builder** button.
    ...
    {{source=CodeSnippets\CS\SQL\SelectProductsForBandReport.sql}}

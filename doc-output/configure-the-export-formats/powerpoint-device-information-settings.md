...
| UseSvgImages          | Boolean  | A flag specifying whether to embed SVG images for Graph, Gauge, Barcode, Shape, and Cross-Section report items using the Office 2019 SVGBlip extension. When enabled, the exported items use resolution-independent vector graphics instead of raster images. The default value is **false**.                      |

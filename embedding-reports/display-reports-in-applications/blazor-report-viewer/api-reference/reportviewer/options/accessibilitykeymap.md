...
description: "Gets or sets the key shortcuts map, used when the report viewer is in accessible mode."
slug: telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/blazor-report-viewer/api-reference/reportviewer/options/accessibilitykeymap
published: True
reportingArea: BlazorWrapper
---

# The `AccessibilityKeyMap` option of the Blazor Report Viewer
...
* [AuthenticationToken]({%slug telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/blazor-report-viewer/api-reference/reportviewer/options/authenticationtoken%})

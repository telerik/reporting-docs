...
description: "Gets or sets the options of the built-in parameter editors."
slug: telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/blazor-report-viewer/api-reference/reportviewer/options/parameters
published: True
reportingArea: BlazorWrapper
---

# The `Parameters` option of the Blazor Report Viewer

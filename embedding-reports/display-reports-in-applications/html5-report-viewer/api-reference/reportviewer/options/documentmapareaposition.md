...
description: "The position of the document map area. See [DocumentMapAreaPositions]({%slug telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/types/documentmapareapositions%})."
...
The position of the document map area. See [DocumentMapAreaPositions]({%slug telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/types/documentmapareapositions%}).

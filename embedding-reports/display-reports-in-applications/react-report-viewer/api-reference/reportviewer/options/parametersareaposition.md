...
description: "Specifies where the Parameters Area should be displayed. Available values: \"RIGHT\", \"TOP\", \"LEFT\", \"BOTTOM\". Default value is \"RIGHT\"."
slug: telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/react-report-viewer/api-reference/reportviewer/options/parametersareaposition
published: True
reportingArea: React
---

# The `parametersAreaPosition` option of the React Report Viewer
...
* [parametersAreaVisible]({%slug telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/react-report-viewer/api-reference/reportviewer/options/parametersareavisible%})

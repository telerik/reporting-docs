...
- **Telerik.Reporting.Services.HttpClient.dll** - this assembly contains the client used to make requests and process response from the REST service Web API. The assembly can be found in the **\bin** subfolder of the Telerik Reporting installation folder. Make sure the _CopyLocal_ property is set to **true**.

...
1. Next you should tell SharePoint that the Reporting assemblies are safe to use. To do so you should add a few `<SafeControl>` entries within the `<SafeControls>` section of your `web.config`:

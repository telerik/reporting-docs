...
Gets the report viewer's <xref href="Telerik.ReportViewer.Blazor.ScaleMode" data-throw-if-not-resolved="false"></xref>.

Returns: the current *System.Threading.Tasks.ValueTask{Telerik.ReportViewer.Blazor.ScaleMode}* object.

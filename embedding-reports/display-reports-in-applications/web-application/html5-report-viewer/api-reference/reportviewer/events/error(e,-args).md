...
slug: old-telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/events/error(e,-args)
tags: error,args
published: false
reportingArea: HTML5
position: 1
previous_url:
- /html5-report-viewer-reportviewer-events-error
- /embedding-reports/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/events/error(e,-args)
---
<style>
...
# The `error(e, args)` Event of the HTML5 Report Viewer

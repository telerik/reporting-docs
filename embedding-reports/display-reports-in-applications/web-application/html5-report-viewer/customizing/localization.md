...
## Solution for releases R3 2023 or newer
...
## Solution for releases R2 2023 or older

1. To localize the report viewer messages, create a new JavaScript file with the required string resources. You may use:

	* the resource file that gets deployed with the installation of the product in the subfolder `Html5\ReportViewer\js\telerikReportViewer.stringResources-{version}.js`, for example:

		`C:\Program Files (x86)\Progress\Telerik Reporting R2 2023\Html5\ReportViewer\js\telerikReportViewer.stringResources-17.1.23.718.js`

...
To find when the report viewer is loaded, provide an event handler function for the __telerik_ReportViewer__ widget's [ready()](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/events) event:

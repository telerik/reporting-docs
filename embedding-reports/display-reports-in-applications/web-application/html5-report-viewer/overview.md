...
<body>
	<table>
		...
		<tr>
			<td><svg style="height: 35px; padding: 5px;" viewBox="0 0 512 512"><path d="M416 141.3 301.3 256 416 370.7 370.7 416 256 301.3 141.3 416 96 370.7 210.7 256 96 141.3 141.3 96 256 210.7 370.7 96z"></path></svg></td>
		...
		<tr>
			<td><svg style="height: 35px; padding: 5px;" viewBox="0 0 512 512"><path d="m160 256 192-128v256z"></path></svg></td>
			<td>Goes to the previous page</td>
		</tr>
		<tr>
			<td><svg style="height: 35px; padding: 5px;" viewBox="0 0 512 512"><path d="M352 256 160 384V128z"></path></svg></td>
        ...
        <tr>
			<td><svg style="height: 35px; padding: 5px;" viewBox="0 0 512 512"><path d="M448 32H64c-17.6 0-32 14.4-32 32v288c0 17.6 14.4 32 32 32h384c17.6 0 32-14.4 32-32V64c0-17.6-14.4-32-32-32m0 319.942a1 1 0 0 1-.058.058H64.058a.5.5 0 0 1-.058-.058V64.057a1 1 0 0 1 .057-.057h383.885q.031.027.058.057zM384 480H128c35.346 0 64-28.654 64-64h128c0 35.346 28.654 64 64 64m32-160H96c58.263-113.973 183.21-192 320-192z"></path></svg></td>
			<td>Toggles the Scale mode of the Report Viewer between FullPage/PageWidth</td>
		</tr>
		<tr>
			<td><svg style="height: 35px; padding: 5px;" viewBox="0 0 512 512"><path d="M352 32H96c-17.7 0-32 14.3-32 32v384c0 17.7 14.3 32 32 32h320c17.7 0 32-14.3 32-32V128zm64 416H96V64h224v96h96z"></path></svg></td>
		...
		<tr>
			<td><svg style="height: 35px; padding: 5px;" viewBox="0 0 512 512"><path d="M448 480V96h-32v352H128c-17.6 0-32-14.4-32-32s14.4-32 32-32h256V32H128c-35.2 0-64 28.8-64 64v320c0 23.6 12.9 44.2 32 55.3 9.4 5.5 20.4 8.7 32 8.7zM128 64h224v288H128zm192 64H160V96h160zm0 128H160v-32h160zm-32-64H160v-32h128z"></path></svg></td>
			<td>Toggle the Document Map</td>
		</tr>
		<tr>
			<td><svg style="height: 35px; padding: 5px;" viewBox="0 0 512 512"><path d="M64 64v32l160 160v224l64-64V256L448 96V64z"></path></svg></td>

---
title: executeCommand(commandName, commandValue)
page_title: The executeCommand(commandName, commandValue) method of the Native Angular Report Viewer explained
description: "Learn more about the executeCommand(commandName, commandValue) method of the Native Angular Report Viewer and how to use it to customize the viewer's behavior."
slug: telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/native-angular-report-viewer/api-reference/reportviewer/methods/executecommand(commandname,-commandvalue)
tags: executecommand
published: True
...
# The `executeCommand(commandName, commandValue)` method of the Native Angular Report Viewer

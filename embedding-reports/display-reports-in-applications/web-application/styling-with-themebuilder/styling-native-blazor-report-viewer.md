...
- `kendo-color-base`: This variable defines the primary accent color for the viewer. It influences various subcomponents, such as the export button, the zoom combo box button, the action buttons of the modals and the parameter editors.

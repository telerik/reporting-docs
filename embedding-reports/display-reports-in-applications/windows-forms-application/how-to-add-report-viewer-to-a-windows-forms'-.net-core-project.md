...
1. Add the following assembly references (available in the Telerik Reporting installation Bin directory) or NuGet package references (available in [Telerik private NuGet repository](slug:telerikreporting/using-reports-in-applications/install-with-nuget-packages)):
   - Telerik.Reporting

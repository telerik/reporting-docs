...
1. Add references to the following [Telerik UI for WPF](https://www.telerik.com/products/wpf/overview.aspx) `NoXaml` assemblies:
   ...
   - _Telerik.Windows.Controls.ConversationalUI.dll_

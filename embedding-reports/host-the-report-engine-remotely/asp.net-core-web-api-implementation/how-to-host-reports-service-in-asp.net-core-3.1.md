...
1. In the __Create a new ASP.NET Core web application__ dialog select from the drop downs `.NET Core` and `ASP.NET Core 3.1` or later. Next, from the list of templates select `Empty` project template and click __Create__.

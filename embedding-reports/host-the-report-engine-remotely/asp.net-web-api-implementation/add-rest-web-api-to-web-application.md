...
The project has a preconfigured implementation of the reports controller that uses the _"~\Reports"_ path for its report source resolver. This directory is not automatically created and needs to be created, or the path to be modified accordingly, prior to running the project.

...
1. Add references to the following Telerik Reporting assemblies (optional) and set their **Copy Local** properties to true in Visual Studio:
	...
	> important Without setting Telerik Reporting references' **Copy Local** to true, the assemblies may not be loaded correctly when running the application.

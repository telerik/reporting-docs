...
| [Create AI Thread]({%slug telerikreporting/using-reports-in-applications/host-the-report-engine-remotely/telerik-reporting-rest-services/rest-api-reference/general-api/create-ai-thread%})|POST|/api/reports/clients/{clientId}/instances/{instanceId}/ai|

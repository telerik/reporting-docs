...
- [Adding the Windows Forms Report Viewer Control to a Windows Forms .NET Project](slug: telerikreporting/using-reports-in-applications/display-reports-in-applications/windows-forms-application/how-to-add-report-viewer-to-a-windows-forms'-.net-core-project)
  ...
  {{source=CodeSnippets\VB\API\Telerik\ReportViewer\WinForms\MyDotNetForm.vb region=WinFormsViewer_DotNet_InitializationInLoad}}
...
Telerik Reporting also provides dedicated wrappers of the pure HTML5 Report Viewer for the most popular ASP.NET MVC and Web Forms frameworks:

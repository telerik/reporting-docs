...
As of the **2026 Q3** release, the Telerik Reporting NuGet packages are hosted on [NuGet.org](https://www.nuget.org/)
...
When working with releases before **2026 Q3**, it is necessary to use the private token-based authentication for the Telerik NuGet feed. In this section, we will explain how to create and use NuGet API keys to restore Telerik NuGet packages in your CI/CD workflows.

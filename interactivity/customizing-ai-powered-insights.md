...
> The RAG functionality is available only in .NET and .NET Standard configurations.

{{source=CodeSnippets\Blazor\Docs\Controllers\ReportsControllerAi.cs region=RAG_Optimization_Monitoring}}

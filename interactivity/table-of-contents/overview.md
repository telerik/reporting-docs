...
The `TocLevel` must evaluate to an `Integer` greater than or equal to 1. If the value cannot be evaluated to an Integer, the TOC level will be set based on the [Default TOC Hierarchy](#default-toc-hierarchy).

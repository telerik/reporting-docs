...
The **HTML5 Report Viewer** exposes a dedicated property for setting a token to be passed with its requests - [authenticationToken](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/overview#options), which may be set in the [viewerInitializing](slug:telerikreporting/report-designer-tools/web-report-designer/web-report-designer-initialization#viewerinitializing) event of the Web Report Designer:

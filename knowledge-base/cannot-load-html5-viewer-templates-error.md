...
* Check the HTML5 Viewer [`serviceUrl`](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/overview) and adjust the relative path.
...
* The issue might be related to duplicating routes of the WebAPI controllers. To avoid such a possibility, [change the Telerik Reporting REST Web API routes registered by default](slug:how-to-change-reporting-rest-web-api-routes-registered-by-default).

...
Here is a sample code you may apply in the [renderingEnd](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/events#renderingend) event handler of the viewer:
```JavaScript
$("#reportViewer1")

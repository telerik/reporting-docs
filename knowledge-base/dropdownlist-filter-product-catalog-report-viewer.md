---
title: Using DropDownList for Language Filter in Product Catalog Report Viewer
...
- How to customize the Language filter in Telerik Reporting?  
- How to configure a DropDownList filter in an HTML5 Report Viewer?  
- How to set up parameter editors in Telerik Reporting?  
...
1. Open the `index.html` file or the HTML page where the Report Viewer is configured.
...
- [HTML5 Report Viewer Overview](https://docs.telerik.com/reporting/html5-report-viewer)
- [Report Parameters in Telerik Reporting](https://docs.telerik.com/reporting/report-parameters)
- [Customizing HTML5 Report Viewer](https://docs.telerik.com/reporting/html5-report-viewer-customizing)

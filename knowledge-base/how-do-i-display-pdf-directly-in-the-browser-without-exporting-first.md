...
1. Create *ExportToPDF()* method (see code example below) to your application.
1. Call the *ExportToPDF()* method. For example you might call this within a button click event handler:

...
1. ReportBook can be created in the Standalone report designer first using the Report Book report template. The output will be a .TRBP file that can be passed to the report viewer's report source as [UriReportSource](/reporting/api/Telerik.Reporting.UriReportSource).

...
## Solution
We may use the _ItemDataBound_ event of the Report to [serialize the report definition](https://docs.telerik.com/reporting/programmatic-xml-serialization#serialize-to-xml) and save it to a TRDX/XML file, or pack it into a TRDP file. Here is a sample code :

...
description: How to migrate your project to utilize the new ReportSource objects.
type: how-to
page_title: How to migrate your project to utilize the new ReportSource objects
...
Here is a sample snippet that shows how to specify a report for the [SubReport](../report-items-sub-report)  item and its corresponding report parameters:  
...
Here is a sample code snippet that shows how to assign a report to WinForms report viewer:  
 ...
 ** 
## ASP<span>.</span>NET Report Viewer
...
When settnig the report declaratively one should use the [assembly qualified name](http://msdn.microsoft.com/en-us/library/system.type.assemblyqualifiedname.aspx) of the report class. Here is a sample HTML markup of how a report was assigned to the ASP<span>.</span>NET viewer from the web form designer:  
...
Here is a sample XAML markup of how a report was assigned to the WPF viewer:

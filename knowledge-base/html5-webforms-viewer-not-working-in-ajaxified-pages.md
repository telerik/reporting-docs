...
To solve this issue, update the viewer in the page by using ite [exposed Client-Side API](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/web-application/html5-report-viewer/api-reference/reportviewer/methods#reportsource).

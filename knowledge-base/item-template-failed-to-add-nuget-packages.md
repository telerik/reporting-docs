...
You can use a newer WebAPI version by updating the corresponding ([Microsoft.AspNet.WebApi.WebHost](https://www.nuget.org/packages/Microsoft.AspNet.WebApi.WebHost) and [Microsoft.AspNet.WebApi.SelfHost](https://www.nuget.org/packages/Microsoft.AspNet.WebApi.SelfHost)) NuGet packages and applying the following `bindingRedirects` to your application configuration file. Replace `5.1.0.0` with the exact version:

...
1. Use the [ClientSessionTimeout](https://www.telerik.com/products/reporting/documentation/api/telerik.reporting.services.reportserviceconfiguration#telerik_reporting_services_reportserviceconfiguration_clientsessiontimeout) property to control the session expiration time. The default value is 15 minutes.
1. Avoid setting it to zero, as this causes sessions to expire immediately, leading to errors like "410 Gone" when rendering reports.
1. Use a reasonable timeout value to balance performance and user experience.
...
1. Schedule the script to run regularly to prevent database growth.
...
* [Telerik Reporting Troubleshooting in ASP.NET Core]({%slug how-to-troubleshoot-errors-in-asp-net-core-applications%})
* [MsSqlServerStorage API Documentation](https://www.telerik.com/products/reporting/documentation/api/telerik.reporting.cache.mssqlserverstorage)

...
This is in case you use the default MapRoute : url: "{controller}/{action}/{id}". It can be found in `App_Start/RouteConfig.cs` or in `Global.asax` file in the MVC project. With another routing may not work this way.

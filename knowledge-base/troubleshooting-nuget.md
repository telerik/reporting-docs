...
1. Update the credentials for the Telerik NuGet feed by running `dotnet nuget update source -Name "telerik.com" -Source "https://nuget.telerik.com/v3/index.json" -UserName "api-key" -Password "YOUR-API-KEY" -StorePasswordInClearText`.

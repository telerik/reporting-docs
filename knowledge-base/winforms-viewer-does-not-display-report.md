...
To solve this issue, refer to [Assign report to the viewer programmatically](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/windows-forms-application/how-to-add-manually-report-viewer-to-a-windows-forms-net-framework-project) article.

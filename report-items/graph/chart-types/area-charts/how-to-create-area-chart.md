...
published: True
position: 1
previous_url: /GraphHowToCreateAreaChart
---

# Creating Area Charts

This guide will demonstrate how to create a Stacked Area chart when you are using the Graph report item. 

The following image shows a Stacked Area chart.

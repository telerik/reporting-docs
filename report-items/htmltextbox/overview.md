...
* [Edit HtmlTextBox content](slug:htmltextbox_editing)&mdash;The HtmlTextBox supports data-driven inline fields which you can edit in place or through a design-time editor.
* [Styling and formatting](slug:htmltextbox_formatting_and_styling)&mdash;The HtmlTextBox enables you to control the presentation style of its text through the supported CSS attributes and HTML tags, including inline images with the `<img>` tag (introduced in version `20.0.26.211`).

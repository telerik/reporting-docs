...
* [Map structure and elements](slug:telerikreporting/designing-reports/report-structure/map/structure/overview)&mdash;You can utilize all available elements the visual structure of the Map report item supports.
* [Bind the Map to data](slug:telerikreporting/designing-reports/connecting-to-data/data-items/binding-a-data-item-to-data)&mdash;The Map report item allows you to bind it to a single data object where you can control what data and in what way is geographically visualized through the Telerik Reporting Expression engine.

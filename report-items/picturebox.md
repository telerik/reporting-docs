...
> \* With version 18.3.24.1112 the image supports __NoDataMessage__. For more information, you can look here - ({%slug telerikreporting/designing-reports/connecting-to-data/how-to-set-a-no-data-message%})

...
> \* With version 18.3.24.1112 the [PictureBox](/api/telerik.reporting.dataitem#Telerik_Reporting_DataItem_NoDataMessage) item supports __NoDataMessage__. For more information, you can look here - [Setting a No Data Message to Data Items]({%slug telerikreporting/designing-reports/connecting-to-data/how-to-set-a-no-data-message%})

...
{{source=CodeSnippets\CS\API\Telerik\Reporting\StyleRuleCreationSnippets.cs region=CreateTypeSelectorStyleRule}}
...
{{source=CodeSnippets\CS\API\Telerik\Reporting\StyleRuleCreationSnippets.cs region=CreateStyleSelectorStyleRule}}
...
{{source=CodeSnippets\CS\API\Telerik\Reporting\StyleRuleCreationSnippets.cs region=CreateDescendantSelectorStyleRule}}

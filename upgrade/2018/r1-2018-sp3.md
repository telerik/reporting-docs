---
title: R1 2018 SP3
page_title: R1 2018 SP3 Release Overview 
description: "See the changes introduced with Telerik Reporting R1 2018 SP3 that should be considered before upgrading, and the 3rd party products & packages this version depends on."
slug: telerikreporting/upgrade/2018/r1-2018-sp3
tags: r1,2018,sp3
published: True
shonly: True
position: 3
previous_url: /upgrade-path-2018-r1-sp3
---

# R1 2018 SP3 Changes and Dependencies
...
The viewer is built with Telerik UI Controls for WPF __2018.1.220.40__. If you are using a newer version consider adding binding redirects. For more information see: [How to Add report viewer to a WPF .NET Framework project](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/wpf-application/how-to-add-report-viewer-to-a-wpf-.net-framework-project).

### Silverlight Report Viewer

The viewer is built with Telerik UI Controls for Silverlight __2018.1.220.1050__. 

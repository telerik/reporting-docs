...
This article explains the manual changes required when upgrading to Telerik Reporting R3 2023 (17.2.23.1011).
...
[Telerik.Reporting.Drawing.BackgroundImage.ImageData](/reporting/api/Telerik.Reporting.Drawing.BackgroundImage.ImageData) is now of type [Telerik.Reporting.Drawing.BackgroundImage.ImageData](/reporting/api/Telerik.Reporting.Drawing.BackgroundImage.ImageData) to avoid dependency on [System.Drawing.Image](https://learn.microsoft.com/en-us/dotnet/api/system.drawing.image) class. The new class has built-in converters to ensure backwards compatibility. All other assignments must be done through the [Telerik.Drawing.Contract.DrawingFactory](/reporting/api/Telerik.Drawing.Contract.DrawingFactory) instance.
...
The viewer is built with Telerik UI Controls for WPF __2023.3.1009.40__. If you are using a newer version, consider adding binding redirects. For more information see: [How to Add report viewer to a WPF .NET Framework project]({%slug telerikreporting/using-reports-in-applications/display-reports-in-applications/wpf-application/how-to-add-report-viewer-to-a-wpf-.net-framework-project%}).

### WPF Report Viewer for .NET 6

The viewer is built with Telerik UI Controls for WPF __2023.3.1009.60__ and targets .NET 6. 

### WPF Report Viewer for .NET 7

The viewer is built with Telerik UI Controls for WPF __2023.3.1009.70__ and targets .NET 7. 

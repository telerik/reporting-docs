---
title: 2024 Q1 (18.0.24.305)
page_title: 2024 Q1 18.0.24.305 Release Overview
description: "See the changes introduced with Telerik Reporting 2024 Q1 (18.0.24.305) that should be considered before upgrading, and the 3rd party products & packages this version depends on."
slug: telerikreporting/upgrade/2024/2024-q1-18-0-24-305
tags: q1,2024
published: True
position: 1
---

# 2024 Q1 (18.0.24.305) Changes and Dependencies

This article explains the manual changes required when upgrading to Telerik Reporting 2024 Q1 (18.0.24.305).

## Changes

### Reporting Configuration

The Reporting Configuration now has a new item: TypeReferences. It is used to explicitly allow user types to be resolved in both design time and runtime.

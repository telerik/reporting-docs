---
title: 2024 Q2 (18.1.24.514)
page_title: 2024 Q2 Release Overview
description: "See the changes introduced with Telerik Reporting 2024 Q2 (18.1.24.514) that should be considered before upgrading, and the 3rd party products & packages this version depends on."
slug: telerikreporting/upgrade/2024/2024-q2
tags: q2,2024
published: True
position: 2
...
# 2024 Q2 (18.1.24.514) Changes and Dependencies

This article explains the manual changes required when upgrading to Telerik Reporting 2024 Q2 (18.1.24.514).

## Changes

### Framework Support

All Telerik Reporting assets for .NET Framework now target __.NET Framework v4.6.2.__. This includes the distributed assemblies, NuGet packages, and Standalone Report Designer for .NET Framework. All the applications that utilize Telerik Reporting and target .NET Framework version earlier than v4.6.2, must upgrade.

### WinUI Report Viewer

The viewer is built with Telerik UI for WinUI __2.8.2__.

### WPF Report Viewer for .NET Framework

The viewer is built with Telerik UI Controls for WPF __2024.2.514.40__. If you are using a newer version, consider adding binding redirects. For more information see: [How to Add report viewer to a WPF .NET Framework project]({%slug telerikreporting/using-reports-in-applications/display-reports-in-applications/wpf-application/how-to-add-report-viewer-to-a-wpf-.net-framework-project%}).

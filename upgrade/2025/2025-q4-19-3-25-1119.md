---
title: 2025 Q4 (19.3.25.1119)
page_title: 2025 Q4 19.3.25.1119 Release Overview
description: "See the changes introduced with Telerik Reporting 2025 Q4 (19.3.25.1119) that should be considered before upgrading, and the 3rd party products & packages this version depends on."
...
# 2025 Q4 (19.3.25.1119) Changes and Dependencies

This article explains the manual changes required when upgrading to Telerik Reporting 2025 Q4 (19.3.25.1119).

## Changes

### SkiaSharp Dependency

Telerik Reporting now depends on SkiaSharp __3.119.1__ when using the Skia graphics engine.

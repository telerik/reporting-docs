...
The viewer is built with Telerik UI Controls for WPF __2025.04.1321.462__. If you are using a newer version, consider adding binding redirects. For more information, see: [How to Add report viewer to a WPF .NET Framework project](slug: telerikreporting/using-reports-in-applications/display-reports-in-applications/wpf-application/how-to-add-report-viewer-to-a-wpf-.net-framework-project).

### WPF Report Viewer for .NET 8

The viewer is built with Telerik UI Controls for WPF __2025.04.1321.80__ and targets .NET 8.

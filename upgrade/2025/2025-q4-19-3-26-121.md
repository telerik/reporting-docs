---
title: 2025 Q4 (19.3.26.121)
page_title: 2025 Q4 19.3.26.121 Release Overview
description: "See the changes introduced with Telerik Reporting 2025 Q4 (19.3.26.121) that should be considered before upgrading, and the 3rd party products & packages this version depends on."
slug: telerikreporting/upgrade/2025/2025-Q4-19-3-26-121
tags: Q4,2025
published: True
shonly: True
position: 1
...
# 2025 Q4 (19.3.26.121) Changes and Dependencies

This article explains the manual changes required when upgrading to Telerik Reporting 2025 Q4 (19.3.26.121).
...
The viewer is built with Telerik UI Controls for WPF __2025.4.1321.462__. If you are using a newer version, consider adding binding redirects. For more information, see: [How to Add report viewer to a WPF .NET Framework project](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/wpf-application/how-to-add-report-viewer-to-a-wpf-.net-framework-project).

### WPF Report Viewer for .NET 8

The viewer is built with Telerik UI Controls for WPF __2025.4.1321.80__ and targets .NET 8.
...
* Telerik Kendo UI (__2025.4.1111__)
* Telerik Kendo UI Themes (__10.2.0__ or later)
* jQuery (__3.7.1__ or later)
* Browser's native support for Promise objects. When the browser does not support Promise, the viewer will not try to automatically load it. It's the responsibility of the developer to load Promise functionality from a trusted source in the application.

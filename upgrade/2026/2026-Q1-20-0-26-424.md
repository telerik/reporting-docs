---
title: 2026 Q1 (20.0.26.422)
page_title: 2026 Q1 20.0.26.422 Release Overview
description: "See the changes introduced with Telerik Reporting 2026 Q1 (20.0.26.422) that should be considered before upgrading, and the 3rd party products & packages this version depends on."
slug: telerikreporting/upgrade/2026/2026-q1-20-0-26-422
tags: Q1,2026
published: True
shonly: True
position: 4
...
# 2026 Q1 (20.0.26.422) Changes and Dependencies

This article explains the manual changes required when upgrading to Telerik Reporting 2026 Q1 (20.0.26.422).

## Changes

### Reporting Engine Configuration
The default value of __traceVerbosity__ [processing element](slug:telerikreporting/using-reports-in-applications/export-and-configure/configure-the-report-engine/processing-element) is changed from __Verbose__ to __Info__. The change is related to the introduced verbose logging mode intended for performance profiling.

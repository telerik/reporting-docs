...
### HttpClient, WebServiceDataSource Component, ASP.NET Core WebAPI REST Report Service

Connecting a desktop report viewer (WinForms or WPF) to a REST service or Report Server instance in .NET projects now use [System.Text.Json](https://www.nuget.org/packages/System.Text.Json/10.0.2) for serialization and no longer depend on Newtonsoft.Json.

...
The sections below list the dependencies and any upgrade requirements for Telerik Reporting 2026 Q3 (20.2.26.811).
...
The core library references [Telerik.Licensing **1.9.0**](https://www.nuget.org/packages/Telerik.Licensing/1.9.0).

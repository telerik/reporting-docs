---
title: 2026 Q3 (20.2.26.811)
page_title: 2026 Q3 20.2.26.811 Release Overview
description: "See the changes introduced with Telerik Reporting 2026 Q3 (20.2.26.811) that should be considered before upgrading, and the 3rd party products & packages this version depends on."
slug: telerikreporting/upgrade/2026/2026-Q3-20-2-26-811
tags: Q3,2026
published: True
shonly: True
position: 8
...
# 2026 Q3 (20.2.26.811) Changes and Dependencies

This article explains the manual changes required when upgrading to Telerik Reporting 2026 Q3 (20.2.26.811).

## Dependencies

### Telerik Licensing

[Telerik.Licensing **1.9.0**](https://www.nuget.org/packages/Telerik.Licensing/1.9.0).

### WPF Report Viewer for .NET Framework

The viewer is built with Telerik UI Controls for WPF **2026.3.811.462**. If you are using a newer version, consider adding binding redirects. For more information, see: [How to Add report viewer to a WPF .NET Framework project](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/wpf-application/how-to-add-report-viewer-to-a-wpf-.net-framework-project).

### WPF Report Viewer for .NET 8

The viewer is built with Telerik UI Controls for WPF **2026.3.811.80** and targets .NET 8.
...
TRDX, TRDP, and TRBP report definitions created by the Standalone Report Designer now use schema version **http://schemas.telerik.com/reporting/2026/3.0**.

### Standalone Report Designer for .NET targeting .NET 10

TRDX, TRDP, and TRBP report definitions created by the Standalone Report Designer for .NET now use schema version **http://schemas.telerik.com/reporting/2026/3.0**.
...
- Telerik Kendo UI (**2026.2.520**)
- Telerik Kendo UI Themes (**14.3.0**)
...
**Correction:** In *Upgrade Path* articles from 2025 Q4 (19.3.25.1111) through 2026 Q3 (20.1.26.615), the .NET 8+ SQLite version was mistakenly documented as 3.50.4. The correct historical value was 3.49.1. The affected articles are now corrected.

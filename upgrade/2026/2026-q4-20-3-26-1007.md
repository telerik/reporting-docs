---
title: 2026 Q4 (20.3.26.1007)
page_title: 2026 Q4 20.3.26.1007 Release Overview
description: "See the changes introduced with Telerik Reporting 2026 Q4 (20.3.26.1007) that should be considered before upgrading, and the 3rd party products & packages this version depends on."
slug: telerikreporting/upgrade/2026/2026-Q4-20-3-26-1007
tags: Q4,2026
published: True
shonly: True
position: 9
...
# 2026 Q4 (20.3.26.1007) Changes and Dependencies

The sections below list the dependencies and any upgrade requirements for Telerik Reporting 2026 Q4 (20.3.26.1007).
...
The core library references [Telerik.Licensing **1.9.1**](https://www.nuget.org/packages/Telerik.Licensing/1.9.1).

### WPF Report Viewer for .NET Framework

The viewer is built with Telerik UI Controls for WPF **2026.4.1007.462**. If you are using a newer version, consider adding binding redirects. For more information, see: [How to Add report viewer to a WPF .NET Framework project](slug:telerikreporting/using-reports-in-applications/display-reports-in-applications/wpf-application/how-to-add-report-viewer-to-a-wpf-.net-framework-project).

### WPF Report Viewer for .NET 8

The viewer is built with Telerik UI Controls for WPF **2026.4.1007.80** and targets .NET 8.

### WinUI Report Viewer

The viewer is built with Telerik UI for WinUI **4.4.0.0**. The WinUI Report Viewer targets .NET 8.

### Standalone Report Designer targeting .NET Framework 4.6.2

TRDX, TRDP, and TRBP report definitions created by the Standalone Report Designer now use schema version **http://schemas.telerik.com/reporting/2026/4.0**.

### Standalone Report Designer for .NET targeting .NET 10

TRDX, TRDP, and TRBP report definitions created by the Standalone Report Designer for .NET now use schema version **http://schemas.telerik.com/reporting/2026/4.0**.
...
The viewer is built with Telerik UI for Blazor **14.0.0**.
...
The internal cache uses SQLite version **3.53.3** for both .NET Framework and .NET 8+ projects.

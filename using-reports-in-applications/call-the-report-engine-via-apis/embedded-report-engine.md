...
> When you export a [ReportBook]({%slug telerikreporting/designing-reports/report-book/overview%} with the ReportProcessor in TIFF format you have to use the multi document format.
